...
bam_dir = "/gpfs/commons/groups/singh_lab/users/kjakubiak/ipsc/ron_data_may2025_2/Mark_duplicates_outputs"
...
for i in range(0, len(bams)):
    ...
    current_inputs["RNAseq.outdir"] = "/gpfs/commons/groups/singh_lab/users/dongwang/RNA-variant-calling-outputs/RNA-variant-calling-gvcf-May2025-2/" # make this empty directory first
